...
export const COMMENTS: Comment[] = [
  ...
  {
    id: "c4",
    name: "Aurore de Montaigne",
    avatarUrl: "https://ui-avatars.com/api/?name=Aurore+de+Montaigne&background=F59E0B&color=fff",
    country: "Switzerland",
    role: "Donor",
    date: "2026-05-27",
  ...
  },
  {
    ...
    avatarUrl: "https://ui-avatars.com/api/?name=Fatima+Al-Zahrani&background=8B5CF6&color=fff",
  ...
  {
    id: "c10",
    name: "Karl-Heinz Mueller",
    avatarUrl: "https://ui-avatars.com/api/?name=Karl+Heinz&background=14B8A6&color=fff",
    country: "Germany",
    role: "Donor",
    date: "2026-04-20",
...
const names = [
  "Johnathan Smith", "Linda Wu", "Ahmad Al-Harbi", "Tariq Mahmood", "Victoria Sterling", "Sven Lindqvist",
  "Nils Halvorsen", "Camille Dupont", "Sofia Rossi", "Carlos Mendez", "Fatima Al-Sudairy", "Liam O'Connor",
