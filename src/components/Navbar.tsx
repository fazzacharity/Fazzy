      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            {/* LEFT SIDE: New Official Logo (Exactly 2x larger, hanging elegantly) */}
            <button
            ...
            <nav className="hidden lg:flex items-center space-x-0.5">
              ...
              >
                ...
                {activeDropdown === "about" && (
                  <div className="absolute left-0 mt-1 w-64 bg-white/95 backdrop-blur-xl border border-slate-100 rounded-2xl shadow-2xl p-3 z-50 animate-fade-in">
                    <button 
                      onClick={() => handleLinkClick("about")}
                    ...
                    >
                      <div>
                        <span className="block text-xs font-black text-slate-900 group-hover:text-[#F4511E]">{translate("about_foundation", lang)}</span>
