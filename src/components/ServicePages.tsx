...
export const ServicePages: React.FC<ServicePagesProps> = ({ activePage, lang, openDonateModal, setActivePage }) => {
  ...
  const healthAmbassadors = [
    { name: "Dr. Rashid Al-Jameel", specialty: "Oncology", region: "Middle East", facility: "Royal Oncology Core", status: "Active Dispatch", code: "FAZ-MD-8821" },
    { name: "Dr. Elena Rostov", specialty: "Pediatrics & Oncology", region: "Eastern Europe", facility: "St. Jude Coordinated Center", status: "Active Dispatch", code: "FAZ-MD-3094" },
    ...
    { name: "Dr. Mei-Ling Harrison", specialty: "Oncology", region: "Southeast Asia", facility: "Royal Grace Hospital", status: "Active Dispatch", code: "FAZ-MD-7556" },
    { name: "Dr. Gabriel Dubois", specialty: "Emergency Triage", region: "North Africa", facility: "Triage Mobile Unit 4", status: "Active Dispatch", code: "FAZ-MD-9011" },
  ...
  const pageGalleries: Record<string, { img: string; desc: string }[]> = {
    "hiv-support": [
      { img: "https://images.unsplash.com/photo-1594708761181-7e8ceae8bcad?w=800&q=80", desc: "Patient counseling session at our regional wing." },
      { img: "https://images.unsplash.com/photo-1518152006812-cdff2f414c81?q=80&w=600", desc: "State-of-the-art laboratory diagnostic system." },
    ...
    "shelter-placement": [
      ...
      { img: "https://images.unsplash.com/photo-1541829019-3578043b1924?q=80&w=600", desc: "On-site sanitary water filtration systems." },
      { img: "https://images.unsplash.com/photo-1448697517561-56580f124ec0?q=80&w=600", desc: "Daily warm food logistics inside shelter dining wings." }
    ],
    "medical-care": [
  ...
  return (
    <div className="bg-[#FAF9F6] pb-24 text-[#111111] font-sans selection:bg-[#F4511E]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        {/* ==========================================
            GLOBAL SUB-PAGE GALLERY WRAPPER
            ========================================== */}
        {currentGallery.length > 0 && (
          <div className="bg-white border border-slate-100 p-8 md:p-10 rounded-[32px] shadow-sm space-y-6">
            <div className="flex items-center space-x-2 text-[#F4511E]">
              <Sparkles className="w-5 h-5 text-[#F4511E]" />
              <span className="font-mono text-xs font-black uppercase tracking-widest">// SECURE FIELD MEDIA TRACKS</span>
            </div>
            <h3 className="text-xl font-black text-slate-900 uppercase tracking-tight">Active Field Gallery</h3>
            <p className="text-xs text-slate-500 font-medium max-w-xl">
              Real-world documentation of active materials dispatch, laboratory clinical systems, and certified safe facilities operated under our IRS 501(c)(3) programs.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
              {currentGallery.map((item, idx) => (
                <div key={idx} className="group relative overflow-hidden rounded-2xl border border-slate-100 shadow-[0_4px_12px_rgba(0,0,0,0.01)] bg-[#FAFAFA]">
